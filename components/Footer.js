	...
	return (
		<footer className={styles.footerContainer}>
			...
			<div className={styles.iconContainer}>
				...
				<a href="">
					<img alt="youtube" title="youtube" className={styles.footerIcon} src="/icons/youtube-white.png" />
				</a>
				<a href="">
					<img alt="spotify" title="spotify" className={styles.footerIcon} src="/icons/spotify-white.png" />
				</a>
				<a href="">
					<img alt="deezer" title="deezer" className={styles.footerIcon} src="/icons/deezer-white.png" />
				</a>
			</div>
		</footer>
	);
